...
It took me about 5h to complete the project.

### One thing you liked about the project?
I liked the complexity of the project in general, since it requires more effort to complete than the previous one, but at the same time it was not too complex.

### One thing that was particularly challenging about the project?
The most challenging part was lightning. I had several issues e.g. I had to change render mode for spotlight to important, because spotlight didn't look as expected or I had to remove point lights, since after baking they over illuminated the room.